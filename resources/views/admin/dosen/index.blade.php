                ...
                <table class="table table-bodered table-striped text-center" id="table" style="width: 100%">
                    <thead class="bg-primary">
                        <tr>
                            ...
                            <th class="text-white text-center">Nama Lengkap & Gelar</th>
                            <th class="text-white text-center">Nomor Induk Pegawai</th>
...
<div class="modal fade" id="importModal" tabindex="-1" role="dialog" aria-labelledby="importModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="{{route('dosens.import')}}" method="POST" enctype="multipart/form-data">
        @csrf
        ...
        <div class="modal-footer">
          <a href="{{asset('_file/template_import_dosen.xlsx')}}" download="" class="btn btn-success">Unduh Template Excel</a>
